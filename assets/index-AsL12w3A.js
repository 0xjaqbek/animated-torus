 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ig;function Ax(){if(Ig)return ce;Ig=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function x(D){return D===null||typeof D!="object"?null:(D=v&&D[v]||D["@@iterator"],typeof D=="function"?D:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,C={};function M(D,Q,St){this.props=D,this.context=Q,this.refs=C,this.updater=St||y}M.prototype.isReactComponent={},M.prototype.setState=function(D,Q){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,Q,"setState")},M.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function _(){}_.prototype=M.prototype;function B(D,Q,St){this.props=D,this.context=Q,this.refs=C,this.updater=St||y}var O=B.prototype=new _;O.constructor=B,b(O,M.prototype),O.isPureReactComponent=!0;var U=Array.isArray,V={H:null,A:null,T:null,S:null,V:null},k=Object.prototype.hasOwnProperty;function z(D,Q,St,yt,K,vt){return St=vt.ref,{$$typeof:o,type:D,key:Q,ref:St!==void 0?St:null,props:vt}}function Z(D,Q){return z(D.type,Q,void 0,void 0,void 0,D.props)}function w(D){return typeof D=="object"&&D!==null&&D.$$typeof===o}function R(D){var Q={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(St){return Q[St]})}var G=/\/+/g;function lt(D,Q){return typeof D=="object"&&D!==null&&D.key!=null?R(""+D.key):Q.toString(36)}function ot(){}function pt(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(ot,ot):(D.status="pending",D.then(function(Q){D.status==="pending"&&(D.status="fulfilled",D.value=Q)},function(Q){D.status==="pending"&&(D.status="rejected",D.reason=Q)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function ht(D,Q,St,yt,K){var vt=typeof D;(vt==="undefined"||vt==="boolean")&&(D=null);var Tt=!1;if(D===null)Tt=!0;else switch(vt){case"bigint":case"string":case"number":Tt=!0;break;case"object":switch(D.$$typeof){case o:case e:Tt=!0;break;case g:return Tt=D._init,ht(Tt(D._payload),Q,St,yt,K)}}if(Tt)return K=K(D),Tt=yt===""?"."+lt(D,0):yt,U(K)?(St="",Tt!=null&&(St=Tt.replace(G,"$&/")+"/"),ht(K,Q,St,"",function(le){return le})):K!=null&&(w(K)&&(K=Z(K,St+(K.key==null||D&&D.key===K.key?"":(""+K.key).replace(G,"$&/")+"/")+Tt)),Q.push(K)),1;Tt=0;var wt=yt===""?".":yt+":";if(U(D))for(var Ut=0;Ut<D.length;Ut++)yt=D[Ut],vt=wt+lt(yt,Ut),Tt+=ht(yt,Q,St,vt,K);else if(Ut=x(D),typeof Ut=="function")for(D=Ut.call(D),Ut=0;!(yt=D.next()).done;)yt=yt.value,vt=wt+lt(yt,Ut++),Tt+=ht(yt,Q,St,vt,K);else if(vt==="object"){if(typeof D.then=="function")return ht(pt(D),Q,St,yt,K);throw Q=String(D),Error("Objects are not valid as a React child (found: "+(Q==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":Q)+"). If you meant to render a collection of children, use an array instead.")}return Tt}function N(D,Q,St){if(D==null)return D;var yt=[],K=0;return ht(D,yt,"","",function(vt){return Q.call(St,vt,K++)}),yt}function X(D){if(D._status===-1){var Q=D._result;Q=Q(),Q.then(function(St){(D._status===0||D._status===-1)&&(D._status=1,D._result=St)},function(St){(D._status===0||D._status===-1)&&(D._status=2,D._result=St)}),D._status===-1&&(D._status=0,D._result=Q)}if(D._status===1)return D._result.default;throw D._result}var W=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent(Q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)};function Et(){}return ce.Children={map:N,forEach:function(D,Q,St){N(D,function(){Q.apply(this,arguments)},St)},count:function(D){var Q=0;return N(D,function(){Q++}),Q},toArray:function(D){return N(D,function(Q){return Q})||[]},only:function(D){if(!w(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},ce.Component=M,ce.Fragment=i,ce.Profiler=l,ce.PureComponent=B,ce.StrictMode=r,ce.Suspense=m,ce.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=V,ce.__COMPILER_RUNTIME={__proto__:null,c:function(D){return V.H.useMemoCache(D)}},ce.cache=function(D){return function(){return D.apply(null,arguments)}},ce.cloneElement=function(D,Q,St){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var yt=b({},D.props),K=D.key,vt=void 0;if(Q!=null)for(Tt in Q.ref!==void 0&&(vt=void 0),Q.key!==void 0&&(K=""+Q.key),Q)!k.call(Q,Tt)||Tt==="key"||Tt==="__self"||Tt==="__source"||Tt==="ref"&&Q.ref===void 0||(yt[Tt]=Q[Tt]);var Tt=arguments.length-2;if(Tt===1)yt.children=St;else if(1<Tt){for(var wt=Array(Tt),Ut=0;Ut<Tt;Ut++)wt[Ut]=arguments[Ut+2];yt.children=wt}return z(D.type,K,void 0,void 0,vt,yt)},ce.createContext=function(D){return D={$$typeof:h,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:u,_context:D},D},ce.createElement=function(D,Q,St){var yt,K={},vt=null;if(Q!=null)for(yt in Q.key!==void 0&&(vt=""+Q.key),Q)k.call(Q,yt)&&yt!=="key"&&yt!=="__self"&&yt!=="__source"&&(K[yt]=Q[yt]);var Tt=arguments.length-2;if(Tt===1)K.children=St;else if(1<Tt){for(var wt=Array(Tt),Ut=0;Ut<Tt;Ut++)wt[Ut]=arguments[Ut+2];K.children=wt}if(D&&D.defaultProps)for(yt in Tt=D.defaultProps,Tt)K[yt]===void 0&&(K[yt]=Tt[yt]);return z(D,vt,void 0,void 0,null,K)},ce.createRef=function(){return{current:null}},ce.forwardRef=function(D){return{$$typeof:d,render:D}},ce.isValidElement=w,ce.lazy=function(D){return{$$typeof:g,_payload:{_status:-1,_result:D},_init:X}},ce.memo=function(D,Q){return{$$typeof:p,type:D,compare:Q===void 0?null:Q}},ce.startTransition=function(D){var Q=V.T,St={};V.T=St;try{var yt=D(),K=V.S;K!==null&&K(St,yt),typeof yt=="object"&&yt!==null&&typeof yt.then=="function"&&yt.then(Et,W)}catch(vt){W(vt)}finally{V.T=Q}},ce.unstable_useCacheRefresh=function(){return V.H.useCacheRefresh()},ce.use=function(D){return V.H.use(D)},ce.useActionState=function(D,Q,St){return V.H.useActionState(D,Q,St)},ce.useCallback=function(D,Q){return V.H.useCallback(D,Q)},ce.useContext=function(D){return V.H.useContext(D)},ce.useDebugValue=function(){},ce.useDeferredValue=function(D,Q){return V.H.useDeferredValue(D,Q)},ce.useEffect=function(D,Q,St){var yt=V.H;if(typeof St=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return yt.useEffect(D,Q)},ce.useId=function(){return V.H.useId()},ce.useImperativeHandle=function(D,Q,St){return V.H.useImperativeHandle(D,Q,St)},ce.useInsertionEffect=function(D,Q){return V.H.useInsertionEffect(D,Q)},ce.useLayoutEffect=function(D,Q){return V.H.useLayoutEffect(D,Q)},ce.useMemo=function(D,Q){return V.H.useMemo(D,Q)},ce.useOptimistic=function(D,Q){return V.H.useOptimistic(D,Q)},ce.useReducer=function(D,Q,St){return V.H.useReducer(D,Q,St)},ce.useRef=function(D){return V.H.useRef(D)},ce.useState=function(D){return V.H.useState(D)},ce.useSyncExternalStore=function(D,Q,St){return V.H.useSyncExternalStore(D,Q,St)},ce.useTransition=function(){return V.H.useTransition()},ce.version="19.1.0",ce}var Fg;function Qh(){return Fg||(Fg=1,Cf.exports=Ax()),Cf.exports}var Qt=Qh(),wf={exports:{}},Mo={},Df={exports:{}},Uf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hg;function Rx(){return Hg||(Hg=1,function(o){function e(N,X){var W=N.length;N.push(X);t:for(;0<W;){var Et=W-1>>>1,D=N[Et];if(0<l(D,X))N[Et]=X,N[W]=D,W=Et;else break t}}function i(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var X=N[0],W=N.pop();if(W!==X){N[0]=W;t:for(var Et=0,D=N.length,Q=D>>>1;Et<Q;){var St=2*(Et+1)-1,yt=N[St],K=St+1,vt=N[K];if(0>l(yt,W))K<D&&0>l(vt,yt)?(N[Et]=vt,N[K]=W,Et=K):(N[Et]=yt,N[St]=W,Et=St);else if(K<D&&0>l(vt,W))N[Et]=vt,N[K]=W,Et=K;else break t}}return X}function l(N,X){var W=N.sortIndex-X.sortIndex;return W!==0?W:N.id-X.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,v=null,x=3,y=!1,b=!1,C=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,O=typeof setImmediate<"u"?setImmediate:null;function U(N){for(var X=i(p);X!==null;){if(X.callback===null)r(p);else if(X.startTime<=N)r(p),X.sortIndex=X.expirationTime,e(m,X);else break;X=i(p)}}function V(N){if(C=!1,U(N),!b)if(i(m)!==null)b=!0,k||(k=!0,lt());else{var X=i(p);X!==null&&ht(V,X.startTime-N)}}var k=!1,z=-1,Z=5,w=-1;function R(){return M?!0:!(o.unstable_now()-w<Z)}function G(){if(M=!1,k){var N=o.unstable_now();w=N;var X=!0;try{t:{b=!1,C&&(C=!1,B(z),z=-1),y=!0;var W=x;try{e:{for(U(N),v=i(m);v!==null&&!(v.expirationTime>N&&R());){var Et=v.callback;if(typeof Et=="function"){v.callback=null,x=v.priorityLevel;var D=Et(v.expirationTime<=N);if(N=o.unstable_now(),typeof D=="function"){v.callback=D,U(N),X=!0;break e}v===i(m)&&r(m),U(N)}else r(m);v=i(m)}if(v!==null)X=!0;else{var Q=i(p);Q!==null&&ht(V,Q.startTime-N),X=!1}}break t}finally{v=null,x=W,y=!1}X=void 0}}finally{X?lt():k=!1}}}var lt;if(typeof O=="function")lt=function(){O(G)};else if(typeof MessageChannel<"u"){var ot=new MessageChannel,pt=ot.port2;ot.port1.onmessage=G,lt=function(){pt.postMessage(null)}}else lt=function(){_(G,0)};function ht(N,X){z=_(function(){N(o.unstable_now())},X)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(N){N.callback=null},o.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<N?Math.floor(1e3/N):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(N){switch(x){case 1:case 2:case 3:var X=3;break;default:X=x}var W=x;x=X;try{return N()}finally{x=W}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(N,X){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var W=x;x=N;try{return X()}finally{x=W}},o.unstable_scheduleCallback=function(N,X,W){var Et=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?Et+W:Et):W=Et,N){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=W+D,N={id:g++,callback:X,priorityLevel:N,startTime:W,expirationTime:D,sortIndex:-1},W>Et?(N.sortIndex=W,e(p,N),i(m)===null&&N===i(p)&&(C?(B(z),z=-1):C=!0,ht(V,W-Et))):(N.sortIndex=D,e(m,N),b||y||(b=!0,k||(k=!0,lt()))),N},o.unstable_shouldYield=R,o.unstable_wrapCallback=function(N){var X=x;return function(){var W=x;x=X;try{return N.apply(this,arguments)}finally{x=W}}}}(Uf)),Uf}var Gg;function Cx(){return Gg||(Gg=1,Df.exports=Rx()),Df.exports}var Lf={exports:{}},wn={};/**
 * @license React
...
}`;function wb(o,e,i){let r=new pv;const l=new Ge,u=new Ge,h=new nn,d=new eM({depthPacking:hS}),m=new nM,p={},g=i.maxTextureSize,v={[ka]:Fn,[Fn]:ka,[aa]:aa},x=new Xa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ge},radius:{value:4}},vertexShader:Rb,fragmentShader:Cb}),y=x.clone();y.defines.HORIZONTAL_PASS=1;const b=new Wa;b.setAttribute("position",new Ni(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Li(b,x),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Y_;let _=this.type;this.render=function(k,z,Z){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||k.length===0)return;const w=o.getRenderTarget(),R=o.getActiveCubeFace(),G=o.getActiveMipmapLevel(),lt=o.state;lt.setBlending(Ga),lt.buffers.color.setClear(1,1,1,1),lt.buffers.depth.setTest(!0),lt.setScissorTest(!1);const ot=_!==ia&&this.type===ia,pt=_===ia&&this.type!==ia;for(let ht=0,N=k.length;ht<N;ht++){const X=k[ht],W=X.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;l.copy(W.mapSize);const Et=W.getFrameExtents();if(l.multiply(Et),u.copy(W.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(u.x=Math.floor(g/Et.x),l.x=u.x*Et.x,W.mapSize.x=u.x),l.y>g&&(u.y=Math.floor(g/Et.y),l.y=u.y*Et.y,W.mapSize.y=u.y)),W.map===null||ot===!0||pt===!0){const Q=this.type!==ia?{minFilter:Si,magFilter:Si}:{};W.map!==null&&W.map.dispose(),W.map=new Tr(l.x,l.y,Q),W.map.texture.name=X.name+".shadowMap",W.camera.updateProjectionMatrix()}o.setRenderTarget(W.map),o.clear();const D=W.getViewportCount();for(let Q=0;Q<D;Q++){const St=W.getViewport(Q);h.set(u.x*St.x,u.y*St.y,u.x*St.z,u.y*St.w),lt.viewport(h),W.updateMatrices(X,Q),r=W.getFrustum(),U(z,Z,W.camera,X,this.type)}W.isPointLightShadow!==!0&&this.type===ia&&B(W,Z),W.needsUpdate=!1}_=this.type,M.needsUpdate=!1,o.setRenderTarget(w,R,G)};function B(k,z){const Z=e.update(C);x.defines.VSM_SAMPLES!==k.blurSamples&&(x.defines.VSM_SAMPLES=k.blurSamples,y.defines.VSM_SAMPLES=k.blurSamples,x.needsUpdate=!0,y.needsUpdate=!0),k.mapPass===null&&(k.mapPass=new Tr(l.x,l.y)),x.uniforms.shadow_pass.value=k.map.texture,x.uniforms.resolution.value=k.mapSize,x.uniforms.radius.value=k.radius,o.setRenderTarget(k.mapPass),o.clear(),o.renderBufferDirect(z,null,Z,x,C,null),y.uniforms.shadow_pass.value=k.mapPass.texture,y.uniforms.resolution.value=k.mapSize,y.uniforms.radius.value=k.radius,o.setRenderTarget(k.map),o.clear(),o.renderBufferDirect(z,null,Z,y,C,null)}function O(k,z,Z,w){let R=null;const G=Z.isPointLight===!0?k.customDistanceMaterial:k.customDepthMaterial;if(G!==void 0)R=G;else if(R=Z.isPointLight===!0?m:d,o.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const lt=R.uuid,ot=z.uuid;let pt=p[lt];pt===void 0&&(pt={},p[lt]=pt);let ht=pt[ot];ht===void 0&&(ht=R.clone(),pt[ot]=ht,z.addEventListener("dispose",V)),R=ht}if(R.visible=z.visible,R.wireframe=z.wireframe,w===ia?R.side=z.shadowSide!==null?z.shadowSide:z.side:R.side=z.shadowSide!==null?z.shadowSide:v[z.side],R.alphaMap=z.alphaMap,R.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,R.map=z.map,R.clipShadows=z.clipShadows,R.clippingPlanes=z.clippingPlanes,R.clipIntersection=z.clipIntersection,R.displacementMap=z.displacementMap,R.displacementScale=z.displacementScale,R.displacementBias=z.displacementBias,R.wireframeLinewidth=z.wireframeLinewidth,R.linewidth=z.linewidth,Z.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const lt=o.properties.get(R);lt.light=Z}return R}function U(k,z,Z,w,R){if(k.visible===!1)return;if(k.layers.test(z.layers)&&(k.isMesh||k.isLine||k.isPoints)&&(k.castShadow||k.receiveShadow&&R===ia)&&(!k.frustumCulled||r.intersectsObject(k))){k.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,k.matrixWorld);const ot=e.update(k),pt=k.material;if(Array.isArray(pt)){const ht=ot.groups;for(let N=0,X=ht.length;N<X;N++){const W=ht[N],Et=pt[W.materialIndex];if(Et&&Et.visible){const D=O(k,Et,w,R);k.onBeforeShadow(o,k,z,Z,ot,D,W),o.renderBufferDirect(Z,null,ot,D,k,W),k.onAfterShadow(o,k,z,Z,ot,D,W)}}}else if(pt.visible){const ht=O(k,pt,w,R);k.onBeforeShadow(o,k,z,Z,ot,ht,null),o.renderBufferDirect(Z,null,ot,ht,k,null),k.onAfterShadow(o,k,z,Z,ot,ht,null)}}const lt=k.children;for(let ot=0,pt=lt.length;ot<pt;ot++)U(lt[ot],z,Z,w,R)}function V(k){k.target.removeEventListener("dispose",V);for(const Z in p){const w=p[Z],R=k.target.uuid;R in w&&(w[R].dispose(),delete w[R])}}}const Db={[hh]:dh,[ph]:_h,[mh]:vh,[Ss]:gh,[dh]:hh,[_h]:ph,[vh]:mh,[gh]:Ss};function Ub(o,e){function i(){let F=!1;const Dt=new nn;let Mt=null;const Lt=new nn(0,0,0,0);return{setMask:function(bt){Mt!==bt&&!F&&(o.colorMask(bt,bt,bt,bt),Mt=bt)},setLocked:function(bt){F=bt},setClear:function(bt,mt,Ft,Yt,Me){Me===!0&&(bt*=Yt,mt*=Yt,Ft*=Yt),Dt.set(bt,mt,Ft,Yt),Lt.equals(Dt)===!1&&(o.clearColor(bt,mt,Ft,Yt),Lt.copy(Dt))},reset:function(){F=!1,Mt=null,Lt.set(-1,0,0,0)}}}function r(){let F=!1,Dt=!1,Mt=null,Lt=null,bt=null;return{setReversed:function(mt){if(Dt!==mt){const Ft=e.get("EXT_clip_control");mt?Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.ZERO_TO_ONE_EXT):Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.NEGATIVE_ONE_TO_ONE_EXT),Dt=mt;const Yt=bt;bt=null,this.setClear(Yt)}},getReversed:function(){return Dt},setTest:function(mt){mt?wt(o.DEPTH_TEST):Ut(o.DEPTH_TEST)},setMask:function(mt){Mt!==mt&&!F&&(o.depthMask(mt),Mt=mt)},setFunc:function(mt){if(Dt&&(mt=Db[mt]),Lt!==mt){switch(mt){case hh:o.depthFunc(o.NEVER);break;case dh:o.depthFunc(o.ALWAYS);break;case ph:o.depthFunc(o.LESS);break;case Ss:o.depthFunc(o.LEQUAL);break;case mh:o.depthFunc(o.EQUAL);break;case gh:o.depthFunc(o.GEQUAL);break;case _h:o.depthFunc(o.GREATER);break;case vh:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Lt=mt}},setLocked:function(mt){F=mt},setClear:function(mt){bt!==mt&&(Dt&&(mt=1-mt),o.clearDepth(mt),bt=mt)},reset:function(){F=!1,Mt=null,Lt=null,bt=null,Dt=!1}}}function l(){let F=!1,Dt=null,Mt=null,Lt=null,bt=null,mt=null,Ft=null,Yt=null,Me=null;return{setTest:function(me){F||(me?wt(o.STENCIL_TEST):Ut(o.STENCIL_TEST))},setMask:function(me){Dt!==me&&!F&&(o.stencilMask(me),Dt=me)},setFunc:function(me,Sn,$e){(Mt!==me||Lt!==Sn||bt!==$e)&&(o.stencilFunc(me,Sn,$e),Mt=me,Lt=Sn,bt=$e)},setOp:function(me,Sn,$e){(mt!==me||Ft!==Sn||Yt!==$e)&&(o.stencilOp(me,Sn,$e),mt=me,Ft=Sn,Yt=$e)},setLocked:function(me){F=me},setClear:function(me){Me!==me&&(o.clearStencil(me),Me=me)},reset:function(){F=!1,Dt=null,Mt=null,Lt=null,bt=null,mt=null,Ft=null,Yt=null,Me=null}}}const u=new i,h=new r,d=new l,m=new WeakMap,p=new WeakMap;let g={},v={},x=new WeakMap,y=[],b=null,C=!1,M=null,_=null,B=null,O=null,U=null,V=null,k=null,z=new Oe(0,0,0),Z=0,w=!1,R=null,G=null,lt=null,ot=null,pt=null;const ht=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let N=!1,X=0;const W=o.getParameter(o.VERSION);W.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(W)[1]),N=X>=1):W.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),N=X>=2);let Et=null,D={};const Q=o.getParameter(o.SCISSOR_BOX),St=o.getParameter(o.VIEWPORT),yt=new nn().fromArray(Q),K=new nn().fromArray(St);function vt(F,Dt,Mt,Lt){const bt=new Uint8Array(4),mt=o.createTexture();o.bindTexture(F,mt),o.texParameteri(F,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(F,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Ft=0;Ft<Mt;Ft++)F===o.TEXTURE_3D||F===o.TEXTURE_2D_ARRAY?o.texImage3D(Dt,0,o.RGBA,1,1,Lt,0,o.RGBA,o.UNSIGNED_BYTE,bt):o.texImage2D(Dt+Ft,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,bt);return mt}const Tt={};Tt[o.TEXTURE_2D]=vt(o.TEXTURE_2D,o.TEXTURE_2D,1),Tt[o.TEXTURE_CUBE_MAP]=vt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),Tt[o.TEXTURE_2D_ARRAY]=vt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),Tt[o.TEXTURE_3D]=vt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),h.setClear(1),d.setClear(0),wt(o.DEPTH_TEST),h.setFunc(Ss),Se(!1),ee(qg),wt(o.CULL_FACE),I(Ga);function wt(F){g[F]!==!0&&(o.enable(F),g[F]=!0)}function Ut(F){g[F]!==!1&&(o.disable(F),g[F]=!1)}function le(F,Dt){return v[F]!==Dt?(o.bindFramebuffer(F,Dt),v[F]=Dt,F===o.DRAW_FRAMEBUFFER&&(v[o.FRAMEBUFFER]=Dt),F===o.FRAMEBUFFER&&(v[o.DRAW_FRAMEBUFFER]=Dt),!0):!1}function Jt(F,Dt){let Mt=y,Lt=!1;if(F){Mt=x.get(Dt),Mt===void 0&&(Mt=[],x.set(Dt,Mt));const bt=F.textures;if(Mt.length!==bt.length||Mt[0]!==o.COLOR_ATTACHMENT0){for(let mt=0,Ft=bt.length;mt<Ft;mt++)Mt[mt]=o.COLOR_ATTACHMENT0+mt;Mt.length=bt.length,Lt=!0}}else Mt[0]!==o.BACK&&(Mt[0]=o.BACK,Lt=!0);Lt&&o.drawBuffers(Mt)}function we(F){return b!==F?(o.useProgram(F),b=F,!0):!1}const xe={[xr]:o.FUNC_ADD,[Ix]:o.FUNC_SUBTRACT,[Fx]:o.FUNC_REVERSE_SUBTRACT};xe[Hx]=o.MIN,xe[Gx]=o.MAX;const oe={[Vx]:o.ZERO,[kx]:o.ONE,[Xx]:o.SRC_COLOR,[uh]:o.SRC_ALPHA,[Kx]:o.SRC_ALPHA_SATURATE,[jx]:o.DST_COLOR,[qx]:o.DST_ALPHA,[Wx]:o.ONE_MINUS_SRC_COLOR,[fh]:o.ONE_MINUS_SRC_ALPHA,[Zx]:o.ONE_MINUS_DST_COLOR,[Yx]:o.ONE_MINUS_DST_ALPHA,[Qx]:o.CONSTANT_COLOR,[Jx]:o.ONE_MINUS_CONSTANT_COLOR,[$x]:o.CONSTANT_ALPHA,[tS]:o.ONE_MINUS_CONSTANT_ALPHA};function I(F,Dt,Mt,Lt,bt,mt,Ft,Yt,Me,me){if(F===Ga){C===!0&&(Ut(o.BLEND),C=!1);return}if(C===!1&&(wt(o.BLEND),C=!0),F!==Bx){if(F!==M||me!==w){if((_!==xr||U!==xr)&&(o.blendEquation(o.FUNC_ADD),_=xr,U=xr),me)switch(F){case _s:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Yg:o.blendFunc(o.ONE,o.ONE);break;case jg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Zg:o.blendFuncSeparate(o.ZERO,o.SRC_COLOR,o.ZERO,o.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case _s:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Yg:o.blendFunc(o.SRC_ALPHA,o.ONE);break;case jg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Zg:o.blendFunc(o.ZERO,o.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}B=null,O=null,V=null,k=null,z.set(0,0,0),Z=0,M=F,w=me}return}bt=bt||Dt,mt=mt||Mt,Ft=Ft||Lt,(Dt!==_||bt!==U)&&(o.blendEquationSeparate(xe[Dt],xe[bt]),_=Dt,U=bt),(Mt!==B||Lt!==O||mt!==V||Ft!==k)&&(o.blendFuncSeparate(oe[Mt],oe[Lt],oe[mt],oe[Ft]),B=Mt,O=Lt,V=mt,k=Ft),(Yt.equals(z)===!1||Me!==Z)&&(o.blendColor(Yt.r,Yt.g,Yt.b,Me),z.copy(Yt),Z=Me),M=F,w=!1}function cn(F,Dt){F.side===aa?Ut(o.CULL_FACE):wt(o.CULL_FACE);let Mt=F.side===Fn;Dt&&(Mt=!Mt),Se(Mt),F.blending===_s&&F.transparent===!1?I(Ga):I(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),h.setFunc(F.depthFunc),h.setTest(F.depthTest),h.setMask(F.depthWrite),u.setMask(F.colorWrite);const Lt=F.stencilWrite;d.setTest(Lt),Lt&&(d.setMask(F.stencilWriteMask),d.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),d.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),he(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?wt(o.SAMPLE_ALPHA_TO_COVERAGE):Ut(o.SAMPLE_ALPHA_TO_COVERAGE)}function Se(F){R!==F&&(F?o.frontFace(o.CW):o.frontFace(o.CCW),R=F)}function ee(F){F!==Ox?(wt(o.CULL_FACE),F!==G&&(F===qg?o.cullFace(o.BACK):F===Px?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):Ut(o.CULL_FACE),G=F}function Wt(F){F!==lt&&(N&&o.lineWidth(F),lt=F)}function he(F,Dt,Mt){F?(wt(o.POLYGON_OFFSET_FILL),(ot!==Dt||pt!==Mt)&&(o.polygonOffset(Dt,Mt),ot=Dt,pt=Mt)):Ut(o.POLYGON_OFFSET_FILL)}function qt(F){F?wt(o.SCISSOR_TEST):Ut(o.SCISSOR_TEST)}function ne(F){F===void 0&&(F=o.TEXTURE0+ht-1),Et!==F&&(o.activeTexture(F),Et=F)}function We(F,Dt,Mt){Mt===void 0&&(Et===null?Mt=o.TEXTURE0+ht-1:Mt=Et);let Lt=D[Mt];Lt===void 0&&(Lt={type:void 0,texture:void 0},D[Mt]=Lt),(Lt.type!==F||Lt.texture!==Dt)&&(Et!==Mt&&(o.activeTexture(Mt),Et=Mt),o.bindTexture(F,Dt||Tt[F]),Lt.type=F,Lt.texture=Dt)}function L(){const F=D[Et];F!==void 0&&F.type!==void 0&&(o.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function E(){try{o.compressedTexImage2D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function et(){try{o.compressedTexImage3D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function dt(){try{o.texSubImage2D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function gt(){try{o.texSubImage3D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ct(){try{o.compressedTexSubImage2D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Pt(){try{o.compressedTexSubImage3D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Nt(){try{o.texStorage2D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Xt(){try{o.texStorage3D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ut(){try{o.texImage2D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function $(){try{o.texImage3D(...arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Rt(F){yt.equals(F)===!1&&(o.scissor(F.x,F.y,F.z,F.w),yt.copy(F))}function zt(F){K.equals(F)===!1&&(o.viewport(F.x,F.y,F.z,F.w),K.copy(F))}function Bt(F,Dt){let Mt=p.get(Dt);Mt===void 0&&(Mt=new WeakMap,p.set(Dt,Mt));let Lt=Mt.get(F);Lt===void 0&&(Lt=o.getUniformBlockIndex(Dt,F.name),Mt.set(F,Lt))}function At(F,Dt){const Lt=p.get(Dt).get(F);m.get(Dt)!==Lt&&(o.uniformBlockBinding(Dt,Lt,F.__bindingPointIndex),m.set(Dt,Lt))}function Zt(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),h.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),g={},Et=null,D={},v={},x=new WeakMap,y=[],b=null,C=!1,M=null,_=null,B=null,O=null,U=null,V=null,k=null,z=new Oe(0,0,0),Z=0,w=!1,R=null,G=null,lt=null,ot=null,pt=null,yt.set(0,0,o.canvas.width,o.canvas.height),K.set(0,0,o.canvas.width,o.canvas.height),u.reset(),h.reset(),d.reset()}return{buffers:{color:u,depth:h,stencil:d},enable:wt,disable:Ut,bindFramebuffer:le,drawBuffers:Jt,useProgram:we,setBlending:I,setMaterial:cn,setFlipSided:Se,setCullFace:ee,setLineWidth:Wt,setPolygonOffset:he,setScissorTest:qt,activeTexture:ne,bindTexture:We,unbindTexture:L,compressedTexImage2D:E,compressedTexImage3D:et,texImage2D:ut,texImage3D:$,updateUBOMapping:Bt,uniformBlockBinding:At,texStorage2D:Nt,texStorage3D:Xt,texSubImage2D:dt,texSubImage3D:gt,compressedTexSubImage2D:ct,compressedTexSubImage3D:Pt,scissor:Rt,viewport:zt,reset:Zt}}function Lb(o,e,i,r,l,u,h){const d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Ge,g=new WeakMap;let v;const x=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(L,E){return y?new OffscreenCanvas(L,E):Sc("canvas")}function C(L,E,et){let dt=1;const gt=We(L);if((gt.width>et||gt.height>et)&&(dt=et/Math.max(gt.width,gt.height)),dt<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const ct=Math.floor(dt*gt.width),Pt=Math.floor(dt*gt.height);v===void 0&&(v=b(ct,Pt));const Nt=E?b(ct,Pt):v;return Nt.width=ct,Nt.height=Pt,Nt.getContext("2d").drawImage(L,0,0,ct,Pt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+gt.width+"x"+gt.height+") to ("+ct+"x"+Pt+")."),Nt}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+gt.width+"x"+gt.height+")."),L;return L}function M(L){return L.generateMipmaps}function _(L){o.generateMipmap(L)}function B(L){return L.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:L.isWebGL3DRenderTarget?o.TEXTURE_3D:L.isWebGLArrayRenderTarget||L.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function O(L,E,et,dt,gt=!1){if(L!==null){if(o[L]!==void 0)return o[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let ct=E;if(E===o.RED&&(et===o.FLOAT&&(ct=o.R32F),et===o.HALF_FLOAT&&(ct=o.R16F),et===o.UNSIGNED_BYTE&&(ct=o.R8)),E===o.RED_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.R8UI),et===o.UNSIGNED_SHORT&&(ct=o.R16UI),et===o.UNSIGNED_INT&&(ct=o.R32UI),et===o.BYTE&&(ct=o.R8I),et===o.SHORT&&(ct=o.R16I),et===o.INT&&(ct=o.R32I)),E===o.RG&&(et===o.FLOAT&&(ct=o.RG32F),et===o.HALF_FLOAT&&(ct=o.RG16F),et===o.UNSIGNED_BYTE&&(ct=o.RG8)),E===o.RG_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.RG8UI),et===o.UNSIGNED_SHORT&&(ct=o.RG16UI),et===o.UNSIGNED_INT&&(ct=o.RG32UI),et===o.BYTE&&(ct=o.RG8I),et===o.SHORT&&(ct=o.RG16I),et===o.INT&&(ct=o.RG32I)),E===o.RGB_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.RGB8UI),et===o.UNSIGNED_SHORT&&(ct=o.RGB16UI),et===o.UNSIGNED_INT&&(ct=o.RGB32UI),et===o.BYTE&&(ct=o.RGB8I),et===o.SHORT&&(ct=o.RGB16I),et===o.INT&&(ct=o.RGB32I)),E===o.RGBA_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.RGBA8UI),et===o.UNSIGNED_SHORT&&(ct=o.RGBA16UI),et===o.UNSIGNED_INT&&(ct=o.RGBA32UI),et===o.BYTE&&(ct=o.RGBA8I),et===o.SHORT&&(ct=o.RGBA16I),et===o.INT&&(ct=o.RGBA32I)),E===o.RGB&&et===o.UNSIGNED_INT_5_9_9_9_REV&&(ct=o.RGB9_E5),E===o.RGBA){const Pt=gt?vc:Ce.getTransfer(dt);et===o.FLOAT&&(ct=o.RGBA32F),et===o.HALF_FLOAT&&(ct=o.RGBA16F),et===o.UNSIGNED_BYTE&&(ct=Pt===Ie?o.SRGB8_ALPHA8:o.RGBA8),et===o.UNSIGNED_SHORT_4_4_4_4&&(ct=o.RGBA4),et===o.UNSIGNED_SHORT_5_5_5_1&&(ct=o.RGB5_A1)}return(ct===o.R16F||ct===o.R32F||ct===o.RG16F||ct===o.RG32F||ct===o.RGBA16F||ct===o.RGBA32F)&&e.get("EXT_color_buffer_float"),ct}function U(L,E){let et;return L?E===null||E===Er||E===wo?et=o.DEPTH24_STENCIL8:E===ra?et=o.DEPTH32F_STENCIL8:E===Co&&(et=o.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Er||E===wo?et=o.DEPTH_COMPONENT24:E===ra?et=o.DEPTH_COMPONENT32F:E===Co&&(et=o.DEPTH_COMPONENT16),et}function V(L,E){return M(L)===!0||L.isFramebufferTexture&&L.minFilter!==Si&&L.minFilter!==Ui?Math.log2(Math.max(E.width,E.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?E.mipmaps.length:1}function k(L){const E=L.target;E.removeEventListener("dispose",k),Z(E),E.isVideoTexture&&g.delete(E)}function z(L){const E=L.target;E.removeEventListener("dispose",z),R(E)}function Z(L){const E=r.get(L);if(E.__webglInit===void 0)return;const et=L.source,dt=x.get(et);if(dt){const gt=dt[E.__cacheKey];gt.usedTimes--,gt.usedTimes===0&&w(L),Object.keys(dt).length===0&&x.delete(et)}r.remove(L)}function w(L){const E=r.get(L);o.deleteTexture(E.__webglTexture);const et=L.source,dt=x.get(et);delete dt[E.__cacheKey],h.memory.textures--}function R(L){const E=r.get(L);if(L.depthTexture&&(L.depthTexture.dispose(),r.remove(L.depthTexture)),L.isWebGLCubeRenderTarget)for(let dt=0;dt<6;dt++){if(Array.isArray(E.__webglFramebuffer[dt]))for(let gt=0;gt<E.__webglFramebuffer[dt].length;gt++)o.deleteFramebuffer(E.__webglFramebuffer[dt][gt]);else o.deleteFramebuffer(E.__webglFramebuffer[dt]);E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer[dt])}else{if(Array.isArray(E.__webglFramebuffer))for(let dt=0;dt<E.__webglFramebuffer.length;dt++)o.deleteFramebuffer(E.__webglFramebuffer[dt]);else o.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&o.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let dt=0;dt<E.__webglColorRenderbuffer.length;dt++)E.__webglColorRenderbuffer[dt]&&o.deleteRenderbuffer(E.__webglColorRenderbuffer[dt]);E.__webglDepthRenderbuffer&&o.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const et=L.textures;for(let dt=0,gt=et.length;dt<gt;dt++){const ct=r.get(et[dt]);ct.__webglTexture&&(o.deleteTexture(ct.__webglTexture),h.memory.textures--),r.remove(et[dt])}r.remove(L)}let G=0;function lt(){G=0}function ot(){const L=G;return L>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+l.maxTextures),G+=1,L}function pt(L){const E=[];return E.push(L.wrapS),E.push(L.wrapT),E.push(L.wrapR||0),E.push(L.magFilter),E.push(L.minFilter),E.push(L.anisotropy),E.push(L.internalFormat),E.push(L.format),E.push(L.type),E.push(L.generateMipmaps),E.push(L.premultiplyAlpha),E.push(L.flipY),E.push(L.unpackAlignment),E.push(L.colorSpace),E.join()}function ht(L,E){const et=r.get(L);if(L.isVideoTexture&&qt(L),L.isRenderTargetTexture===!1&&L.version>0&&et.__version!==L.version){const dt=L.image;if(dt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(dt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Tt(et,L,E);return}}i.bindTexture(o.TEXTURE_2D,et.__webglTexture,o.TEXTURE0+E)}function N(L,E){const et=r.get(L);if(L.version>0&&et.__version!==L.version){Tt(et,L,E);return}i.bindTexture(o.TEXTURE_2D_ARRAY,et.__webglTexture,o.TEXTURE0+E)}function X(L,E){const et=r.get(L);if(L.version>0&&et.__version!==L.version){Tt(et,L,E);return}i.bindTexture(o.TEXTURE_3D,et.__webglTexture,o.TEXTURE0+E)}function W(L,E){const et=r.get(L);if(L.version>0&&et.__version!==L.version){wt(et,L,E);return}i.bindTexture(o.TEXTURE_CUBE_MAP,et.__webglTexture,o.TEXTURE0+E)}const Et={[Mh]:o.REPEAT,[Mr]:o.CLAMP_TO_EDGE,[yh]:o.MIRRORED_REPEAT},D={[Si]:o.NEAREST,[uS]:o.NEAREST_MIPMAP_NEAREST,[Xl]:o.NEAREST_MIPMAP_LINEAR,[Ui]:o.LINEAR,[Nf]:o.LINEAR_MIPMAP_NEAREST,[yr]:o.LINEAR_MIPMAP_LINEAR},Q={[mS]:o.NEVER,[MS]:o.ALWAYS,[gS]:o.LESS,[av]:o.LEQUAL,[_S]:o.EQUAL,[SS]:o.GEQUAL,[vS]:o.GREATER,[xS]:o.NOTEQUAL};function St(L,E){if(E.type===ra&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===Ui||E.magFilter===Nf||E.magFilter===Xl||E.magFilter===yr||E.minFilter===Ui||E.minFilter===Nf||E.minFilter===Xl||E.minFilter===yr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(L,o.TEXTURE_WRAP_S,Et[E.wrapS]),o.texParameteri(L,o.TEXTURE_WRAP_T,Et[E.wrapT]),(L===o.TEXTURE_3D||L===o.TEXTURE_2D_ARRAY)&&o.texParameteri(L,o.TEXTURE_WRAP_R,Et[E.wrapR]),o.texParameteri(L,o.TEXTURE_MAG_FILTER,D[E.magFilter]),o.texParameteri(L,o.TEXTURE_MIN_FILTER,D[E.minFilter]),E.compareFunction&&(o.texParameteri(L,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(L,o.TEXTURE_COMPARE_FUNC,Q[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Si||E.minFilter!==Xl&&E.minFilter!==yr||E.type===ra&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const et=e.get("EXT_texture_filter_anisotropic");o.texParameterf(L,et.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function yt(L,E){let et=!1;L.__webglInit===void 0&&(L.__webglInit=!0,E.addEventListener("dispose",k));const dt=E.source;let gt=x.get(dt);gt===void 0&&(gt={},x.set(dt,gt));const ct=pt(E);if(ct!==L.__cacheKey){gt[ct]===void 0&&(gt[ct]={texture:o.createTexture(),usedTimes:0},h.memory.textures++,et=!0),gt[ct].usedTimes++;const Pt=gt[L.__cacheKey];Pt!==void 0&&(gt[L.__cacheKey].usedTimes--,Pt.usedTimes===0&&w(E)),L.__cacheKey=ct,L.__webglTexture=gt[ct].texture}return et}function K(L,E,et){return Math.floor(Math.floor(L/et)/E)}function vt(L,E,et,dt){const ct=L.updateRanges;if(ct.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,E.width,E.height,et,dt,E.data);else{ct.sort(($,Rt)=>$.start-Rt.start);let Pt=0;for(let $=1;$<ct.length;$++){const Rt=ct[Pt],zt=ct[$],Bt=Rt.start+Rt.count,At=K(zt.start,E.width,4),Zt=K(Rt.start,E.width,4);zt.start<=Bt+1&&At===Zt&&K(zt.start+zt.count-1,E.width,4)===At?Rt.count=Math.max(Rt.count,zt.start+zt.count-Rt.start):(++Pt,ct[Pt]=zt)}ct.length=Pt+1;const Nt=o.getParameter(o.UNPACK_ROW_LENGTH),Xt=o.getParameter(o.UNPACK_SKIP_PIXELS),ut=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,E.width);for(let $=0,Rt=ct.length;$<Rt;$++){const zt=ct[$],Bt=Math.floor(zt.start/4),At=Math.ceil(zt.count/4),Zt=Bt%E.width,F=Math.floor(Bt/E.width),Dt=At,Mt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,Zt),o.pixelStorei(o.UNPACK_SKIP_ROWS,F),i.texSubImage2D(o.TEXTURE_2D,0,Zt,F,Dt,Mt,et,dt,E.data)}L.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Nt),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Xt),o.pixelStorei(o.UNPACK_SKIP_ROWS,ut)}}function Tt(L,E,et){let dt=o.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(dt=o.TEXTURE_2D_ARRAY),E.isData3DTexture&&(dt=o.TEXTURE_3D);const gt=yt(L,E),ct=E.source;i.bindTexture(dt,L.__webglTexture,o.TEXTURE0+et);const Pt=r.get(ct);if(ct.version!==Pt.__version||gt===!0){i.activeTexture(o.TEXTURE0+et);const Nt=Ce.getPrimaries(Ce.workingColorSpace),Xt=E.colorSpace===Ha?null:Ce.getPrimaries(E.colorSpace),ut=E.colorSpace===Ha||Nt===Xt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);let $=C(E.image,!1,l.maxTextureSize);$=ne(E,$);const Rt=u.convert(E.format,E.colorSpace),zt=u.convert(E.type);let Bt=O(E.internalFormat,Rt,zt,E.colorSpace,E.isVideoTexture);St(dt,E);let At;const Zt=E.mipmaps,F=E.isVideoTexture!==!0,Dt=Pt.__version===void 0||gt===!0,Mt=ct.dataReady,Lt=V(E,$);if(E.isDepthTexture)Bt=U(E.format===Uo,E.type),Dt&&(F?i.texStorage2D(o.TEXTURE_2D,1,Bt,$.width,$.height):i.texImage2D(o.TEXTURE_2D,0,Bt,$.width,$.height,0,Rt,zt,null));else if(E.isDataTexture)if(Zt.length>0){F&&Dt&&i.texStorage2D(o.TEXTURE_2D,Lt,Bt,Zt[0].width,Zt[0].height);for(let bt=0,mt=Zt.length;bt<mt;bt++)At=Zt[bt],F?Mt&&i.texSubImage2D(o.TEXTURE_2D,bt,0,0,At.width,At.height,Rt,zt,At.data):i.texImage2D(o.TEXTURE_2D,bt,Bt,At.width,At.height,0,Rt,zt,At.data);E.generateMipmaps=!1}else F?(Dt&&i.texStorage2D(o.TEXTURE_2D,Lt,Bt,$.width,$.height),Mt&&vt(E,$,Rt,zt)):i.texImage2D(o.TEXTURE_2D,0,Bt,$.width,$.height,0,Rt,zt,$.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){F&&Dt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Lt,Bt,Zt[0].width,Zt[0].height,$.depth);for(let bt=0,mt=Zt.length;bt<mt;bt++)if(At=Zt[bt],E.format!==xi)if(Rt!==null)if(F){if(Mt)if(E.layerUpdates.size>0){const Ft=g_(At.width,At.height,E.format,E.type);for(const Yt of E.layerUpdates){const Me=At.data.subarray(Yt*Ft/At.data.BYTES_PER_ELEMENT,(Yt+1)*Ft/At.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,bt,0,0,Yt,At.width,At.height,1,Rt,Me)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,bt,0,0,0,At.width,At.height,$.depth,Rt,At.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,bt,Bt,At.width,At.height,$.depth,0,At.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else F?Mt&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,bt,0,0,0,At.width,At.height,$.depth,Rt,zt,At.data):i.texImage3D(o.TEXTURE_2D_ARRAY,bt,Bt,At.width,At.height,$.depth,0,Rt,zt,At.data)}else{F&&Dt&&i.texStorage2D(o.TEXTURE_2D,Lt,Bt,Zt[0].width,Zt[0].height);for(let bt=0,mt=Zt.length;bt<mt;bt++)At=Zt[bt],E.format!==xi?Rt!==null?F?Mt&&i.compressedTexSubImage2D(o.TEXTURE_2D,bt,0,0,At.width,At.height,Rt,At.data):i.compressedTexImage2D(o.TEXTURE_2D,bt,Bt,At.width,At.height,0,At.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):F?Mt&&i.texSubImage2D(o.TEXTURE_2D,bt,0,0,At.width,At.height,Rt,zt,At.data):i.texImage2D(o.TEXTURE_2D,bt,Bt,At.width,At.height,0,Rt,zt,At.data)}else if(E.isDataArrayTexture)if(F){if(Dt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Lt,Bt,$.width,$.height,$.depth),Mt)if(E.layerUpdates.size>0){const bt=g_($.width,$.height,E.format,E.type);for(const mt of E.layerUpdates){const Ft=$.data.subarray(mt*bt/$.data.BYTES_PER_ELEMENT,(mt+1)*bt/$.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,mt,$.width,$.height,1,Rt,zt,Ft)}E.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,Rt,zt,$.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Bt,$.width,$.height,$.depth,0,Rt,zt,$.data);else if(E.isData3DTexture)F?(Dt&&i.texStorage3D(o.TEXTURE_3D,Lt,Bt,$.width,$.height,$.depth),Mt&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,Rt,zt,$.data)):i.texImage3D(o.TEXTURE_3D,0,Bt,$.width,$.height,$.depth,0,Rt,zt,$.data);else if(E.isFramebufferTexture){if(Dt)if(F)i.texStorage2D(o.TEXTURE_2D,Lt,Bt,$.width,$.height);else{let bt=$.width,mt=$.height;for(let Ft=0;Ft<Lt;Ft++)i.texImage2D(o.TEXTURE_2D,Ft,Bt,bt,mt,0,Rt,zt,null),bt>>=1,mt>>=1}}else if(Zt.length>0){if(F&&Dt){const bt=We(Zt[0]);i.texStorage2D(o.TEXTURE_2D,Lt,Bt,bt.width,bt.height)}for(let bt=0,mt=Zt.length;bt<mt;bt++)At=Zt[bt],F?Mt&&i.texSubImage2D(o.TEXTURE_2D,bt,0,0,Rt,zt,At):i.texImage2D(o.TEXTURE_2D,bt,Bt,Rt,zt,At);E.generateMipmaps=!1}else if(F){if(Dt){const bt=We($);i.texStorage2D(o.TEXTURE_2D,Lt,Bt,bt.width,bt.height)}Mt&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Rt,zt,$)}else i.texImage2D(o.TEXTURE_2D,0,Bt,Rt,zt,$);M(E)&&_(dt),Pt.__version=ct.version,E.onUpdate&&E.onUpdate(E)}L.__version=E.version}function wt(L,E,et){if(E.image.length!==6)return;const dt=yt(L,E),gt=E.source;i.bindTexture(o.TEXTURE_CUBE_MAP,L.__webglTexture,o.TEXTURE0+et);const ct=r.get(gt);if(gt.version!==ct.__version||dt===!0){i.activeTexture(o.TEXTURE0+et);const Pt=Ce.getPrimaries(Ce.workingColorSpace),Nt=E.colorSpace===Ha?null:Ce.getPrimaries(E.colorSpace),Xt=E.colorSpace===Ha||Pt===Nt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xt);const ut=E.isCompressedTexture||E.image[0].isCompressedTexture,$=E.image[0]&&E.image[0].isDataTexture,Rt=[];for(let mt=0;mt<6;mt++)!ut&&!$?Rt[mt]=C(E.image[mt],!0,l.maxCubemapSize):Rt[mt]=$?E.image[mt].image:E.image[mt],Rt[mt]=ne(E,Rt[mt]);const zt=Rt[0],Bt=u.convert(E.format,E.colorSpace),At=u.convert(E.type),Zt=O(E.internalFormat,Bt,At,E.colorSpace),F=E.isVideoTexture!==!0,Dt=ct.__version===void 0||dt===!0,Mt=gt.dataReady;let Lt=V(E,zt);St(o.TEXTURE_CUBE_MAP,E);let bt;if(ut){F&&Dt&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Lt,Zt,zt.width,zt.height);for(let mt=0;mt<6;mt++){bt=Rt[mt].mipmaps;for(let Ft=0;Ft<bt.length;Ft++){const Yt=bt[Ft];E.format!==xi?Bt!==null?F?Mt&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft,0,0,Yt.width,Yt.height,Bt,Yt.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft,Zt,Yt.width,Yt.height,0,Yt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?Mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft,0,0,Yt.width,Yt.height,Bt,At,Yt.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft,Zt,Yt.width,Yt.height,0,Bt,At,Yt.data)}}}else{if(bt=E.mipmaps,F&&Dt){bt.length>0&&Lt++;const mt=We(Rt[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Lt,Zt,mt.width,mt.height)}for(let mt=0;mt<6;mt++)if($){F?Mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,0,0,Rt[mt].width,Rt[mt].height,Bt,At,Rt[mt].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,Zt,Rt[mt].width,Rt[mt].height,0,Bt,At,Rt[mt].data);for(let Ft=0;Ft<bt.length;Ft++){const Me=bt[Ft].image[mt].image;F?Mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft+1,0,0,Me.width,Me.height,Bt,At,Me.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft+1,Zt,Me.width,Me.height,0,Bt,At,Me.data)}}else{F?Mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,0,0,Bt,At,Rt[mt]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,Zt,Bt,At,Rt[mt]);for(let Ft=0;Ft<bt.length;Ft++){const Yt=bt[Ft];F?Mt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft+1,0,0,Bt,At,Yt.image[mt]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ft+1,Zt,Bt,At,Yt.image[mt])}}}M(E)&&_(o.TEXTURE_CUBE_MAP),ct.__version=gt.version,E.onUpdate&&E.onUpdate(E)}L.__version=E.version}function Ut(L,E,et,dt,gt,ct){const Pt=u.convert(et.format,et.colorSpace),Nt=u.convert(et.type),Xt=O(et.internalFormat,Pt,Nt,et.colorSpace),ut=r.get(E),$=r.get(et);if($.__renderTarget=E,!ut.__hasExternalTextures){const Rt=Math.max(1,E.width>>ct),zt=Math.max(1,E.height>>ct);gt===o.TEXTURE_3D||gt===o.TEXTURE_2D_ARRAY?i.texImage3D(gt,ct,Xt,Rt,zt,E.depth,0,Pt,Nt,null):i.texImage2D(gt,ct,Xt,Rt,zt,0,Pt,Nt,null)}i.bindFramebuffer(o.FRAMEBUFFER,L),he(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,dt,gt,$.__webglTexture,0,Wt(E)):(gt===o.TEXTURE_2D||gt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&gt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,dt,gt,$.__webglTexture,ct),i.bindFramebuffer(o.FRAMEBUFFER,null)}function le(L,E,et){if(o.bindRenderbuffer(o.RENDERBUFFER,L),E.depthBuffer){const dt=E.depthTexture,gt=dt&&dt.isDepthTexture?dt.type:null,ct=U(E.stencilBuffer,gt),Pt=E.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Nt=Wt(E);he(E)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Nt,ct,E.width,E.height):et?o.renderbufferStorageMultisample(o.RENDERBUFFER,Nt,ct,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,ct,E.width,E.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,Pt,o.RENDERBUFFER,L)}else{const dt=E.textures;for(let gt=0;gt<dt.length;gt++){const ct=dt[gt],Pt=u.convert(ct.format,ct.colorSpace),Nt=u.convert(ct.type),Xt=O(ct.internalFormat,Pt,Nt,ct.colorSpace),ut=Wt(E);et&&he(E)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,ut,Xt,E.width,E.height):he(E)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,ut,Xt,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,Xt,E.width,E.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Jt(L,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,L),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const dt=r.get(E.depthTexture);dt.__renderTarget=E,(!dt.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),ht(E.depthTexture,0);const gt=dt.__webglTexture,ct=Wt(E);if(E.depthTexture.format===Do)he(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,gt,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,gt,0);else if(E.depthTexture.format===Uo)he(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,gt,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,gt,0);else throw new Error("Unknown depthTexture format")}function we(L){const E=r.get(L),et=L.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==L.depthTexture){const dt=L.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),dt){const gt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,dt.removeEventListener("dispose",gt)};dt.addEventListener("dispose",gt),E.__depthDisposeCallback=gt}E.__boundDepthTexture=dt}if(L.depthTexture&&!E.__autoAllocateDepthBuffer){if(et)throw new Error("target.depthTexture not supported in Cube render targets");const dt=L.texture.mipmaps;dt&&dt.length>0?Jt(E.__webglFramebuffer[0],L):Jt(E.__webglFramebuffer,L)}else if(et){E.__webglDepthbuffer=[];for(let dt=0;dt<6;dt++)if(i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[dt]),E.__webglDepthbuffer[dt]===void 0)E.__webglDepthbuffer[dt]=o.createRenderbuffer(),le(E.__webglDepthbuffer[dt],L,!1);else{const gt=L.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=E.__webglDepthbuffer[dt];o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,gt,o.RENDERBUFFER,ct)}}else{const dt=L.texture.mipmaps;if(dt&&dt.length>0?i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=o.createRenderbuffer(),le(E.__webglDepthbuffer,L,!1);else{const gt=L.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=E.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,gt,o.RENDERBUFFER,ct)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function xe(L,E,et){const dt=r.get(L);E!==void 0&&Ut(dt.__webglFramebuffer,L,L.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),et!==void 0&&we(L)}function oe(L){const E=L.texture,et=r.get(L),dt=r.get(E);L.addEventListener("dispose",z);const gt=L.textures,ct=L.isWebGLCubeRenderTarget===!0,Pt=gt.length>1;if(Pt||(dt.__webglTexture===void 0&&(dt.__webglTexture=o.createTexture()),dt.__version=E.version,h.memory.textures++),ct){et.__webglFramebuffer=[];for(let Nt=0;Nt<6;Nt++)if(E.mipmaps&&E.mipmaps.length>0){et.__webglFramebuffer[Nt]=[];for(let Xt=0;Xt<E.mipmaps.length;Xt++)et.__webglFramebuffer[Nt][Xt]=o.createFramebuffer()}else et.__webglFramebuffer[Nt]=o.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){et.__webglFramebuffer=[];for(let Nt=0;Nt<E.mipmaps.length;Nt++)et.__webglFramebuffer[Nt]=o.createFramebuffer()}else et.__webglFramebuffer=o.createFramebuffer();if(Pt)for(let Nt=0,Xt=gt.length;Nt<Xt;Nt++){const ut=r.get(gt[Nt]);ut.__webglTexture===void 0&&(ut.__webglTexture=o.createTexture(),h.memory.textures++)}if(L.samples>0&&he(L)===!1){et.__webglMultisampledFramebuffer=o.createFramebuffer(),et.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,et.__webglMultisampledFramebuffer);for(let Nt=0;Nt<gt.length;Nt++){const Xt=gt[Nt];et.__webglColorRenderbuffer[Nt]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,et.__webglColorRenderbuffer[Nt]);const ut=u.convert(Xt.format,Xt.colorSpace),$=u.convert(Xt.type),Rt=O(Xt.internalFormat,ut,$,Xt.colorSpace,L.isXRRenderTarget===!0),zt=Wt(L);o.renderbufferStorageMultisample(o.RENDERBUFFER,zt,Rt,L.width,L.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Nt,o.RENDERBUFFER,et.__webglColorRenderbuffer[Nt])}o.bindRenderbuffer(o.RENDERBUFFER,null),L.depthBuffer&&(et.__webglDepthRenderbuffer=o.createRenderbuffer(),le(et.__webglDepthRenderbuffer,L,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ct){i.bindTexture(o.TEXTURE_CUBE_MAP,dt.__webglTexture),St(o.TEXTURE_CUBE_MAP,E);for(let Nt=0;Nt<6;Nt++)if(E.mipmaps&&E.mipmaps.length>0)for(let Xt=0;Xt<E.mipmaps.length;Xt++)Ut(et.__webglFramebuffer[Nt][Xt],L,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Nt,Xt);else Ut(et.__webglFramebuffer[Nt],L,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Nt,0);M(E)&&_(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Pt){for(let Nt=0,Xt=gt.length;Nt<Xt;Nt++){const ut=gt[Nt],$=r.get(ut);i.bindTexture(o.TEXTURE_2D,$.__webglTexture),St(o.TEXTURE_2D,ut),Ut(et.__webglFramebuffer,L,ut,o.COLOR_ATTACHMENT0+Nt,o.TEXTURE_2D,0),M(ut)&&_(o.TEXTURE_2D)}i.unbindTexture()}else{let Nt=o.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(Nt=L.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Nt,dt.__webglTexture),St(Nt,E),E.mipmaps&&E.mipmaps.length>0)for(let Xt=0;Xt<E.mipmaps.length;Xt++)Ut(et.__webglFramebuffer[Xt],L,E,o.COLOR_ATTACHMENT0,Nt,Xt);else Ut(et.__webglFramebuffer,L,E,o.COLOR_ATTACHMENT0,Nt,0);M(E)&&_(Nt),i.unbindTexture()}L.depthBuffer&&we(L)}function I(L){const E=L.textures;for(let et=0,dt=E.length;et<dt;et++){const gt=E[et];if(M(gt)){const ct=B(L),Pt=r.get(gt).__webglTexture;i.bindTexture(ct,Pt),_(ct),i.unbindTexture()}}}const cn=[],Se=[];function ee(L){if(L.samples>0){if(he(L)===!1){const E=L.textures,et=L.width,dt=L.height;let gt=o.COLOR_BUFFER_BIT;const ct=L.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Pt=r.get(L),Nt=E.length>1;if(Nt)for(let ut=0;ut<E.length;ut++)i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+ut,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+ut,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer);const Xt=L.texture.mipmaps;Xt&&Xt.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer);for(let ut=0;ut<E.length;ut++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(gt|=o.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(gt|=o.STENCIL_BUFFER_BIT)),Nt){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Pt.__webglColorRenderbuffer[ut]);const $=r.get(E[ut]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,$,0)}o.blitFramebuffer(0,0,et,dt,0,0,et,dt,gt,o.NEAREST),m===!0&&(cn.length=0,Se.length=0,cn.push(o.COLOR_ATTACHMENT0+ut),L.depthBuffer&&L.resolveDepthBuffer===!1&&(cn.push(ct),Se.push(ct),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,Se)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,cn))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Nt)for(let ut=0;ut<E.length;ut++){i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+ut,o.RENDERBUFFER,Pt.__webglColorRenderbuffer[ut]);const $=r.get(E[ut]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+ut,o.TEXTURE_2D,$,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&m){const E=L.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[E])}}}function Wt(L){return Math.min(l.maxSamples,L.samples)}function he(L){const E=r.get(L);return L.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function qt(L){const E=h.render.frame;g.get(L)!==E&&(g.set(L,E),L.update())}function ne(L,E){const et=L.colorSpace,dt=L.format,gt=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||et!==Es&&et!==Ha&&(Ce.getTransfer(et)===Ie?(dt!==xi||gt!==la)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",et)),E}function We(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(p.width=L.naturalWidth||L.width,p.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(p.width=L.displayWidth,p.height=L.displayHeight):(p.width=L.width,p.height=L.height),p}this.allocateTextureUnit=ot,this.resetTextureUnits=lt,this.setTexture2D=ht,this.setTexture2DArray=N,this.setTexture3D=X,this.setTextureCube=W,this.rebindTextures=xe,this.setupRenderTarget=oe,this.updateRenderTargetMipmap=I,this.updateMultisampleRenderTarget=ee,this.setupDepthRenderbuffer=we,this.setupFrameBufferTexture=Ut,this.useMultisampledRTT=he}function Nb(o,e){function i(r,l=Ha){let u;const h=Ce.getTransfer(l);if(r===la)return o.UNSIGNED_BYTE;if(r===td)return o.UNSIGNED_SHORT_4_4_4_4;if(r===ed)return o.UNSIGNED_SHORT_5_5_5_1;if(r===J_)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===K_)return o.BYTE;if(r===Q_)return o.SHORT;if(r===Co)return o.UNSIGNED_SHORT;if(r===$h)return o.INT;if(r===Er)return o.UNSIGNED_INT;if(r===ra)return o.FLOAT;if(r===Lo)return o.HALF_FLOAT;if(r===$_)return o.ALPHA;if(r===tv)return o.RGB;if(r===xi)return o.RGBA;if(r===Do)return o.DEPTH_COMPONENT;if(r===Uo)return o.DEPTH_STENCIL;if(r===ev)return o.RED;if(r===nd)return o.RED_INTEGER;if(r===nv)return o.RG;if(r===id)return o.RG_INTEGER;if(r===ad)return o.RGBA_INTEGER;if(r===hc||r===dc||r===pc||r===mc)if(h===Ie)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===hc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===dc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===pc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===mc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===hc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===dc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===pc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===mc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Eh||r===Th||r===bh||r===Ah)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Eh)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Th)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===bh)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Ah)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Rh||r===Ch||r===wh)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Rh||r===Ch)return h===Ie?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===wh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Dh||r===Uh||r===Lh||r===Nh||r===Oh||r===Ph||r===zh||r===Bh||r===Ih||r===Fh||r===Hh||r===Gh||r===Vh||r===kh)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===Dh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Uh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Lh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Nh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Oh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Ph)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===zh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Bh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Ih)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Fh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Hh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Gh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===Vh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===kh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===gc||r===Xh||r===Wh)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===gc)return h===Ie?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Xh)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Wh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===iv||r===qh||r===Yh||r===jh)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===gc)return u.COMPRESSED_RED_RGTC1_EXT;if(r===qh)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Yh)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===jh)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===wo?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}const Ob=`
void main() {
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qb=[["polygon",{points:"5 4 15 12 5 20 5 4",key:"16p6eg"}],["line",{x1:"19",x2:"19",y1:"5",y2:"19",key:"futhcm"}]],q_=Bo("skip-forward",Qb),Jb=()=>{const o=Qt.useRef(null),e=Qt.useRef(null),i=Qt.useRef(null),r=Qt.useRef(null),l=Qt.useRef(null),u=Qt.useRef(null),h=Qt.useRef(0),d=Qt.useRef(0),m=Qt.useRef(null),[p,g]=Qt.useState(!1),[v,x]=Qt.useState({x:0,y:0}),[y,b]=Qt.useState({x:0,y:0}),[C,M]=Qt.useState(5),[_,B]=Qt.useState(0),[O,U]=Qt.useState(0),[V,k]=Qt.useState(!1),[z,Z]=Qt.useState(0),w=Qt.useRef(null),[R,G]=Qt.useState(!1),[lt,ot]=Qt.useState(!1),[pt,ht]=Qt.useState(!1),N=Qt.useRef(null),X=Qt.useRef(null),W=Qt.useRef(null),Et=Qt.useRef(null),D=Qt.useRef(null),Q=Qt.useRef({x:0,y:0}),St=Qt.useRef(5),yt=-Math.PI/2,K=0,vt=.04,Tt=.04,wt=1.7,Ut=2e3,le=3e3,Jt=Qt.useCallback(()=>{console.log("Returning to torus position before auto-animation");const ut=Date.now(),$={cameraX:y.x,cameraY:y.y,zoom:C},Rt=()=>{if(!w.current||w.current.paused)return;const zt=Date.now()-ut,Bt=Math.min(zt/1500,1),At=I(Bt),Zt=$.cameraX+(yt-$.cameraX)*At,F=$.cameraY+(K-$.cameraY)*At,Dt=$.zoom+(wt-$.zoom)*At;b({x:Zt,y:F}),M(Dt),Bt<1?requestAnimationFrame(Rt):(console.log("Returned to torus position, now starting auto-animation"),Q.current={x:yt,y:K},St.current=wt,we())};requestAnimationFrame(Rt)},[]),we=Qt.useCallback(()=>{if(X.current||N.current)return;console.log("Starting smooth blend to auto-animation!"),ht(!0),Et.current=Date.now(),W.current=Date.now();const ut={x:yt,y:K,zoom:wt};Q.current={x:yt,y:K},St.current=wt,console.log("Static torus position for transition:",ut),console.log("Base for auto-animation:",Q.current);const $=()=>{if(!w.current||w.current.paused){console.log("Audio stopped during auto-transition"),ht(!1),X.current=null;return}const Rt=Date.now()-Et.current,zt=Math.min(Rt/le,1),Bt=I(zt),At=(Date.now()-W.current)/1e3,Zt=.2,F=.15,Dt=Math.PI/2,Mt=Math.sin(At*Zt)*Dt*.5,Lt=Math.cos(At*Zt*.7)*Dt*.8,bt=Math.sin(At*F)*.8,mt=Math.max(-Math.PI/2,Math.min(Math.PI/2,Q.current.x+Mt)),Ft=Q.current.y+Lt,Yt=Math.max(.6,Math.min(2.2,1.4+bt)),Me=ut.x+(mt-ut.x)*Bt,me=ut.y+(Ft-ut.y)*Bt,Sn=ut.zoom+(Yt-ut.zoom)*Bt;b({x:Me,y:me}),M(Sn),zt<1?X.current=requestAnimationFrame($):(console.log("Blend transition completed, switching to full auto-animation"),ht(!1),X.current=null,Se())};X.current=requestAnimationFrame($)},[]),xe=ut=>`/animated-torus/${ut}`,oe=[{title:"jedynka",artist:"Pronoia",url:xe("AUD-20241228-WA0000.mp3")},{title:"dwojka",artist:"Pronoia",url:xe("AUD-20241228-WA0001.mp3")},{title:"trzeci",artist:"Pronoia",url:xe("AUD-20241228-WA0002.mp3")},{title:"damiana",artist:"Pronoia",url:xe("AUD-20241228-WA0004.mp3")},{title:"siaja",artist:"Pronoia",url:xe("AUD-20241228-WA0003.mp3")},{title:"smutny",artist:"Pronoia",url:xe("AUD-20241228-WA0005.mp3")},{title:"ośem",artist:"Pronoia",url:xe("osmy.mp3")}],I=ut=>ut<.5?4*ut*ut*ut:1-Math.pow(-2*ut+2,3)/2,cn=()=>{if(m.current)return;G(!0);const ut=Date.now(),$={cameraX:y.x,cameraY:y.y,zoom:C,poloidalSpeed:_,rotationalSpeed:O},Rt=()=>{const zt=Date.now()-ut,Bt=Math.min(zt/Ut,1),At=I(Bt),Zt=$.cameraX+(yt-$.cameraX)*At,F=$.cameraY+(K-$.cameraY)*At,Dt=$.zoom+(wt-$.zoom)*At,Mt=$.poloidalSpeed+(vt-$.poloidalSpeed)*At,Lt=$.rotationalSpeed+(Tt-$.rotationalSpeed)*At;b({x:Zt,y:F}),M(Dt),B(Mt),U(Lt),h.current=Mt,d.current=Lt,Bt<1?m.current=requestAnimationFrame(Rt):(G(!1),m.current=null,Q.current={x:yt,y:K},St.current=wt,console.log("Initial transition completed. Base set for auto-animation:",Q.current,"zoom:",St.current))};m.current=requestAnimationFrame(Rt)},Se=Qt.useCallback(()=>{if(N.current)return;console.log("Starting full auto-animation (continuing from transition)!"),ot(!0);const ut=()=>{if(!w.current||w.current.paused){console.log("Audio stopped, ending auto-animation"),ot(!1),N.current=null;return}const $=(Date.now()-W.current)/1e3,Rt=.2,zt=.15,Bt=Math.PI/2,At=Math.sin($*Rt)*Bt*.5,Zt=Math.cos($*Rt*.7)*Bt*.8,F=1.4,Mt=Math.sin($*zt)*.8,Lt=Math.max(-Math.PI/2,Math.min(Math.PI/2,Q.current.x+At)),bt=Q.current.y+Zt,mt=Math.max(.6,Math.min(2.2,F+Mt));Math.floor($*60)%120===0&&console.log(`Auto-animation: elapsed=${$.toFixed(1)}s, x=${Lt.toFixed(2)}, y=${bt.toFixed(2)}, zoom=${mt.toFixed(2)}`),b({x:Lt,y:bt}),M(mt),N.current=requestAnimationFrame(ut)};N.current=requestAnimationFrame(ut)},[]),ee=Qt.useCallback(()=>{console.log("Stopping auto-animation and transitions"),N.current&&(cancelAnimationFrame(N.current),N.current=null),X.current&&(cancelAnimationFrame(X.current),X.current=null),ot(!1),ht(!1)},[]),Wt=Qt.useCallback(()=>{if(u.current){const ut=u.current,$=C;ut.position.x=$*Math.sin(y.y)*Math.cos(y.x),ut.position.y=$*Math.sin(y.x),ut.position.z=$*Math.cos(y.y)*Math.cos(y.x),ut.lookAt(0,0,0)}},[C,y]),he=Qt.useCallback(ut=>{g(!0),x({x:ut.clientX,y:ut.clientY}),(lt||pt)&&ee()},[lt,pt,ee]),qt=Qt.useCallback(ut=>{if(!p)return;const $=ut.clientX-v.x,Rt=ut.clientY-v.y;b(zt=>({x:Math.max(-Math.PI/2,Math.min(Math.PI/2,zt.x+Rt*.01)),y:zt.y+$*.01})),x({x:ut.clientX,y:ut.clientY})},[p,v]),ne=Qt.useCallback(()=>{g(!1)},[]),We=Qt.useCallback(ut=>{ut.preventDefault();const $=ut.touches[0];g(!0),x({x:$.clientX,y:$.clientY}),(lt||pt)&&ee()},[lt,pt,ee]),L=Qt.useCallback(ut=>{if(ut.preventDefault(),!p)return;const $=ut.touches[0],Rt=$.clientX-v.x,zt=$.clientY-v.y;b(Bt=>({x:Math.max(-Math.PI/2,Math.min(Math.PI/2,Bt.x+zt*.01)),y:Bt.y+Rt*.01})),x({x:$.clientX,y:$.clientY})},[p,v]),E=Qt.useCallback(ut=>{ut.preventDefault(),g(!1)},[]),et=Qt.useCallback(ut=>{const $=parseFloat(ut.target.value);M($),(lt||pt)&&ee()},[lt,pt,ee]),dt=Qt.useCallback(ut=>{const $=parseFloat(ut.target.value);B($),h.current=$},[]),gt=Qt.useCallback(ut=>{const $=parseFloat(ut.target.value);U($),d.current=$},[]),ct=Qt.useCallback(()=>{w.current&&(V?(w.current.pause(),k(!1),ee()):(cn(),w.current.play().then(()=>{k(!0),D.current=Date.now(),console.log("Song started, will begin smooth auto-blend in 5 seconds..."),setTimeout(()=>{if(w.current&&!w.current.paused&&D.current){console.log("5 seconds elapsed, starting smooth auto-blend from torus position!");const ut=y.x,$=y.y,Rt=C;Math.abs(ut-yt)<.1&&Math.abs($-K)<.1&&Math.abs(Rt-wt)<.1?(console.log("Still at torus position, starting auto-animation directly"),we()):(console.log("Camera moved from torus position, returning to torus first"),Jt())}else console.log("Audio not playing, skipping auto-blend")},5e3)}).catch(console.error)))},[V]),Pt=Qt.useCallback(()=>{w.current&&w.current.pause(),k(!1),ee(),D.current=null;const ut=(z+1)%oe.length;Z(ut)},[z,oe.length,ee]),Nt=Qt.useCallback(()=>{w.current&&w.current.pause(),k(!1),ee(),D.current=null;const ut=(z-1+oe.length)%oe.length;Z(ut)},[z,oe.length,ee]),Xt=Qt.useCallback(()=>{ee(),Pt()},[Pt,ee]);return Qt.useEffect(()=>{h.current=0,d.current=0;const ut=new JS;ut.background=new Oe(0),e.current=ut;const $=new oi(75,window.innerWidth/window.innerHeight,.1,1e3);u.current=$;const Rt=new Gb({antialias:!0});Rt.setSize(window.innerWidth,window.innerHeight),Rt.setPixelRatio(window.devicePixelRatio),i.current=Rt,o.current&&o.current.appendChild(Rt.domElement);const zt=new ld(1,.4,32,100),Bt=zt.attributes.position.array.slice(),Zt="ontouchstart"in window||navigator.maxTouchPoints>0?1:2,F=new od({color:16777215,wireframe:!0,wireframeLinewidth:Zt}),Dt=new Li(zt,F);ut.add(Dt),r.current=Dt,$.position.set(0,0,C),$.lookAt(0,0,0);let Mt=0;const Lt=()=>{if(Mt+=.02,r.current){const mt=r.current.geometry,Ft=mt.attributes.position.array;for(let Yt=0;Yt<Ft.length;Yt+=3){const Me=Bt[Yt],me=Bt[Yt+1],Sn=Bt[Yt+2],$e=Math.sqrt(Me*Me+me*me),Ze=-Mt*d.current+$e*1.5,an=Math.cos(Ze),Mn=Math.sin(Ze),Mi=Math.atan2(me,Me),qa=1,ua=$e-qa,li=Sn,ci=Math.sqrt(ua*ua+li*li),yi=Math.atan2(li,ua),ui=Mt*h.current,Qn=yi+ui,Pi=ci*Math.cos(Qn),Ei=ci*Math.sin(Qn),Ye=qa+Pi,Ya=Ye*Math.cos(Mi),ja=Ye*Math.sin(Mi),fi=Ya*an-ja*Mn,A=Ya*Mn+ja*an;Ft[Yt]=fi,Ft[Yt+1]=A,Ft[Yt+2]=Ei}mt.attributes.position.needsUpdate=!0}Rt.render(ut,$),l.current=requestAnimationFrame(Lt)};Lt();const bt=()=>{$.aspect=window.innerWidth/window.innerHeight,$.updateProjectionMatrix(),Rt.setSize(window.innerWidth,window.innerHeight)};return window.addEventListener("resize",bt),()=>{window.removeEventListener("resize",bt),l.current&&cancelAnimationFrame(l.current),m.current&&cancelAnimationFrame(m.current),N.current&&cancelAnimationFrame(N.current),X.current&&cancelAnimationFrame(X.current),o.current&&Rt.domElement&&o.current.removeChild(Rt.domElement),Rt.dispose(),zt.dispose(),F.dispose()}},[]),Qt.useEffect(()=>{Wt()},[Wt]),Qt.useEffect(()=>{const ut=i.current?.domElement;if(ut)return ut.addEventListener("mousedown",he),document.addEventListener("mousemove",qt),document.addEventListener("mouseup",ne),ut.addEventListener("mouseleave",ne),ut.addEventListener("touchstart",We,{passive:!1}),ut.addEventListener("touchmove",L,{passive:!1}),ut.addEventListener("touchend",E,{passive:!1}),ut.addEventListener("touchcancel",E,{passive:!1}),()=>{ut.removeEventListener("mousedown",he),document.removeEventListener("mousemove",qt),document.removeEventListener("mouseup",ne),ut.removeEventListener("mouseleave",ne),ut.removeEventListener("touchstart",We),ut.removeEventListener("touchmove",L),ut.removeEventListener("touchend",E),ut.removeEventListener("touchcancel",E)}},[he,qt,ne,We,L,E]),Vt.jsxs("div",{className:"w-full h-screen bg-black overflow-hidden relative",children:[Vt.jsx("div",{ref:o,className:"w-full h-full cursor-grab active:cursor-grabbing touch-none"}),Vt.jsx("audio",{ref:w,src:oe[z].url,onEnded:Xt,onPlay:()=>k(!0),onPause:()=>k(!1)}),Vt.jsx("div",{className:"absolute top-4 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-70 p-4 rounded-lg",children:Vt.jsxs("div",{className:"flex space-x-6 items-center",children:[Vt.jsxs("div",{className:"text-center",children:[Vt.jsx("div",{className:"text-white text-sm mb-2 font-mono",children:"Zoom"}),Vt.jsx("input",{type:"range",min:"0.5",max:"15",step:"0.1",value:C,onChange:et,className:"w-20 slider-horizontal"}),Vt.jsx("div",{className:"text-gray-400 text-xs mt-1 font-mono",children:C.toFixed(1)})]}),Vt.jsxs("div",{className:"text-center",children:[Vt.jsx("div",{className:"text-white text-sm mb-2 font-mono",children:"Poloidalny"}),Vt.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:_,onChange:dt,className:"w-20 slider-horizontal"}),Vt.jsx("div",{className:"text-gray-400 text-xs mt-1 font-mono",children:_.toFixed(2)})]}),Vt.jsxs("div",{className:"text-center",children:[Vt.jsx("div",{className:"text-white text-sm mb-2 font-mono",children:"Rotacyjny"}),Vt.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:O,onChange:gt,className:"w-20 slider-horizontal"}),Vt.jsx("div",{className:"text-gray-400 text-xs mt-1 font-mono",children:O.toFixed(2)})]})]})}),Vt.jsxs("div",{className:"absolute top-4 right-4 lg:block hidden bg-black bg-opacity-80 p-4 rounded-lg border border-gray-600",children:[Vt.jsxs("div",{className:"text-center mb-3 min-w-[200px]",children:[Vt.jsxs("div",{className:"flex items-center justify-center mb-2",children:[Vt.jsx(V_,{size:16,className:"text-white mr-2"}),Vt.jsx("span",{className:"text-white text-sm font-mono",children:"Now Playing"})]}),Vt.jsx("div",{className:"text-white text-sm font-medium mb-1",children:oe[z].title}),Vt.jsx("div",{className:"text-gray-400 text-xs",children:oe[z].artist})]}),Vt.jsxs("div",{className:"flex items-center justify-center space-x-3",children:[Vt.jsx("button",{onClick:Nt,className:"p-2 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors",title:"Previous",children:Vt.jsx(W_,{size:18,className:"text-white"})}),Vt.jsx("button",{onClick:ct,className:"p-3 rounded-full bg-white hover:bg-gray-200 transition-colors",title:V?"Pause":"Play",children:V?Vt.jsx(k_,{size:20,className:"text-black"}):Vt.jsx(X_,{size:20,className:"text-black ml-1"})}),Vt.jsx("button",{onClick:Pt,className:"p-2 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors",title:"Next",children:Vt.jsx(q_,{size:18,className:"text-white"})})]})]}),Vt.jsxs("div",{className:"absolute bottom-8 left-1/2 transform -translate-x-1/2 lg:hidden block bg-black bg-opacity-90 p-3 rounded-lg border border-gray-600 w-11/12 max-w-sm",children:[Vt.jsxs("div",{className:"text-center mb-2",children:[Vt.jsxs("div",{className:"flex items-center justify-center mb-1",children:[Vt.jsx(V_,{size:14,className:"text-white mr-2"}),Vt.jsx("span",{className:"text-white text-xs font-mono",children:"Now Playing"})]}),Vt.jsx("div",{className:"text-white text-sm font-medium mb-1 truncate",children:oe[z].title}),Vt.jsx("div",{className:"text-gray-400 text-xs truncate",children:oe[z].artist})]}),Vt.jsxs("div",{className:"flex items-center justify-center space-x-4",children:[Vt.jsx("button",{onClick:Nt,className:"p-2 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors",title:"Previous",children:Vt.jsx(W_,{size:16,className:"text-white"})}),Vt.jsx("button",{onClick:ct,className:"p-2 rounded-full bg-white hover:bg-gray-200 transition-colors",title:V?"Pause":"Play",children:V?Vt.jsx(k_,{size:18,className:"text-black"}):Vt.jsx(X_,{size:18,className:"text-black ml-0.5"})}),Vt.jsx("button",{onClick:Pt,className:"p-2 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors",title:"Next",children:Vt.jsx(q_,{size:16,className:"text-white"})})]})]}),Vt.jsx("div",{className:"absolute bottom-4 left-4 lg:block hidden text-white font-mono text-sm bg-black bg-opacity-70 p-3 rounded-lg",children:Vt.jsxs("div",{className:"text-center",children:[Vt.jsxs("div",{className:"text-gray-400 text-xs mb-1 flex items-center justify-center",children:["Camera",(lt||pt)&&Vt.jsx("span",{className:"ml-2 text-green-400 text-xs animate-pulse",children:"●"})]}),Vt.jsxs("div",{className:"text-white text-xs",children:["X: ",(y.x*180/Math.PI).toFixed(1),"°"]}),Vt.jsxs("div",{className:"text-white text-xs",children:["Y: ",(y.y*180/Math.PI).toFixed(1),"°"]}),pt&&Vt.jsx("div",{className:"text-yellow-400 text-xs mt-1",children:"Transitioning"}),lt&&Vt.jsx("div",{className:"text-green-400 text-xs mt-1",children:"Auto"})]})}),Vt.jsx("div",{className:"absolute bottom-4 left-4 lg:hidden block text-white font-mono text-xs bg-black bg-opacity-70 p-2 rounded-lg",children:Vt.jsxs("div",{className:"text-center",children:[Vt.jsxs("div",{className:"text-gray-400 text-xs mb-1 flex items-center justify-center",children:["Camera",(lt||pt)&&Vt.jsx("span",{className:"ml-1 text-green-400 text-xs animate-pulse",children:"●"})]}),Vt.jsxs("div",{className:"text-white text-xs",children:["X: ",(y.x*180/Math.PI).toFixed(1),"°"]}),Vt.jsxs("div",{className:"text-white text-xs",children:["Y: ",(y.y*180/Math.PI).toFixed(1),"°"]}),pt&&Vt.jsx("div",{className:"text-yellow-400 text-xs mt-1",children:"Transitioning"}),lt&&Vt.jsx("div",{className:"text-green-400 text-xs mt-1",children:"Auto"})]})}),Vt.jsx("style",{jsx:!0,children:`
        .slider-horizontal {
      ...
      `})]})};Nx.createRoot(document.getElementById("root")).render(Vt.jsx(Qt.StrictMode,{children:Vt.jsx(Jb,{})}));
